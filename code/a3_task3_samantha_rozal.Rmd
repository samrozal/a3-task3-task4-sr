...
Create and return a really awesomely formatted table using the kableExtra package
```{r}
...
```
# Data Visulaization 
 Create a finalized graph of counts of purple urchins recorded at each site
```{r}
ggplot(data= purple_urchins_total, aes(x= year_new,y=count)) +
  ...
  labs(x="Year",
       y= "Urchin count",
       title= "Urchins count by size and year",
       color="Site") 
